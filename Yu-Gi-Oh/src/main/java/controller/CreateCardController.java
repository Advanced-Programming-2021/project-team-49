    ...
    public void createCard() {
        switch (cardType) {
            case "Monster":
                ...
                break;
            case "Spell": {
                SpellTrapCard spellTrapCard = new SpellTrapCard(this.cardName, "", Effect.NONE, EffectType.NORMAL,
                        Status.LIMITED, SpellTrapType.SPELL,
                        getClass().getResource("image/rawCard.png").toExternalForm(), this.price);
                break;
            }
            case "Trap": {
                SpellTrapCard spellTrapCard = new SpellTrapCard(this.cardName, "", Effect.NONE, EffectType.NORMAL,
                        Status.LIMITED, SpellTrapType.TRAP,
                        getClass().getResource("image/rawCard.png").toExternalForm(), this.price);
                break;
            }
        }
